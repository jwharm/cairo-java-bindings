...
public final class PostScriptSurface extends Surface {
	...
	public PostScriptSurface restrictToLevel(PostScriptLevel level) {
		try {
			cairo_ps_surface_restrict_to_level.invoke(handle(), level.ordinal());
			return this;
		} catch (Throwable e) {
			throw new RuntimeException(e);
		}
	...
	private static final MethodHandle cairo_ps_surface_dsc_begin_setup = Interop
			.downcallHandle("cairo_ps_surface_dsc_begin_setup", FunctionDescriptor.ofVoid(ValueLayout.ADDRESS), false);
	...
	private static final MethodHandle cairo_ps_surface_dsc_begin_page_setup = Interop.downcallHandle(
			"cairo_ps_surface_dsc_begin_page_setup", FunctionDescriptor.ofVoid(ValueLayout.ADDRESS), false);
	...
	private static final MethodHandle cairo_ps_surface_dsc_comment = Interop.downcallHandle(
			"cairo_ps_surface_dsc_comment", FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);
}
