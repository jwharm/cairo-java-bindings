...
public final class Context extends ProxyInstance {
    ...
    private static final MethodHandle cairo_set_dash = Interop.downcallHandle("cairo_set_dash", FunctionDescriptor
            .ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_DOUBLE));
    ...
    private static final MethodHandle cairo_in_clip = Interop.downcallHandle("cairo_in_clip", FunctionDescriptor
            .of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_DOUBLE, ValueLayout.JAVA_DOUBLE));
    ...
    private static final MethodHandle cairo_set_user_data = Interop.downcallHandle("cairo_set_user_data",
